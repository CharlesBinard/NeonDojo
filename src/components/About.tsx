...
export default function About() {
  return (
    ...
    >
      ...
      <div className="glass rounded-2xl glow-border p-8">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <motion.div
            className="w-48 h-48 rounded-full bg-gradient-to-br from-neon-cyan to-neon-purple p-1 animate-pulse-glow"
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-3 mt-6 justify-center md:justify-start">
              {['React', 'TypeScript', 'Node.js', 'Python', 'PostgreSQL', 'Docker'].map((tag) => (
                <span
                  key={tag}
