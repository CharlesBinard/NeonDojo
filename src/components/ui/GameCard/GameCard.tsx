...
const hueMap: Record<string, string> = {
  ...
  purple: 'from-neon-purple/20 to-neon-purple/5 border-neon-purple/30 hover:border-neon-purple/60 hover:shadow-[0_0_40px_rgba(191,90,242,0.15)]',
  ...
  green: 'from-green-500/20 to-green-500/5 border-green-500/30 hover:border-green-500/60 hover:shadow-[0_0_40px_rgba(48,209,88,0.15)]',
  yellow: 'from-yellow-400/20 to-yellow-400/5 border-yellow-400/30 hover:border-yellow-400/60 hover:shadow-[0_0_40px_rgba(255,214,10,0.15)]',
  orange: 'from-orange-500/20 to-orange-500/5 border-orange-500/30 hover:border-orange-500/60 hover:shadow-[0_0_40px_rgba(255,159,10,0.15)]',
}
...
export const GameCard = ({ game, onClick, index }: GameCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`mt-4 text-xs font-mono ${textClass} opacity-60`}>
        JOUER →
      </div>
    </motion.button>
  )
